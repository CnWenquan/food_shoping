	...
	export default{
		data () {
			return {
				...
				goods : [],
//				{img:require("../../images/img/l17.png"),name:"云南蒙自石榴8个装",size:"8个装",num:1,score:60},{img:require("../../images/img/l17.png"),name:"云南蒙自石榴8个装",size:"8个装",num:1,score:60},{img:require("../../images/img/l17.png"),name:"福建琯溪白心蜜柚(大果)2个装",size:"8个装",num:1,score:60}
			}
		},
		props:['value'],
		created :function(){
		...
		methods :{
			...
			add :function (index){
				parseFloat(this.goods[index].num);
				parseFloat(this.goods[index].score);
				this.goods[index].num++
				var count = 0;
				for (var i=0;i<this.goods.length;i++) {
					count += this.goods[i].num *this.goods[i].score;
...
//			var	 obj = JSON.parse(localStorage.data);
			this.$axios.get('/api/exchange').then(function(data){
...
.s-detail .s-moren{
	...
	.s-goods-sure li:nth-child(1) img{
		width: 80px;
		height: 80px;
	}
