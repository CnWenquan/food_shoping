	...
	<div class="s-register">
		...
		<div class="s-zhuce">
			<div class="s-zhuce-wrapper">
				<div class="s-resetPass">
					<h3>重置密码</h3>	
				</div>
				<ul class="s-import">
					<li>
						<p><input type="text" placeholder="请输入手机号" @blur="foucs($event)" class="number2"/>
					...
					<li id="s-yanzheng">
						<p><input type="text" name="" id="" value="" placeholder="验证码"/>
					...
					<li>
						<p><input type="password" placeholder="请输入密码(6-20位号码字符)" @blur="pass($event)" class="password2"/>
							<img src="../../images/icon/check .png" alt="" /></p>
						<p><img src="../../images/icon/warning.png" alt="" />
					...
					<li id="s-phone">
						<input type="text" placeholder="手机验证码" />
							<span class="gain" @click="gainYanZheng()">获取验证码</span>
					</li>
					<li class="s-click">
						<span @click="changeP()">提交</span>
					</li>
				</ul>
			</div>
		</div>
